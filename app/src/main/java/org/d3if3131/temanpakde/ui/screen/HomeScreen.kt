...
import org.d3if3131.temanpakde.navigation.Screen
    ...
    Column(
        ...
        Card(
            ...
            Row(
                ...
                Text(
                    text = stringResource(id = R.string.cek_tanggal_panen),
        ...
        Card(
            ...
            Row(
                ...
                Image(
                    painter = painterResource(id = R.mipmap.icon_serangga ),
                ...
                Spacer(modifier = Modifier.weight(0.2f))
                Text(
                    text = stringResource(id = R.string.daftar_penyakit),
                    style = MaterialTheme.typography.titleMedium,
                    color = colorResource(id = R.color.white),
                    modifier = Modifier.weight(1f)
                )
